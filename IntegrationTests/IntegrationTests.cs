...
using PasswordManager; //NB: Exchange this for your projects namespace and add a reference to your own project
...
namespace IntegrationTests
{
    ...
    public class IntegrationTests
    {
        ...
        public void GetCommandCanRetriveIndividuallySetData()
        {
            ...
            string response1 = get(clientPath1, serverPath, pwd1, prop1).Split("\n")[^1];
            ...
            string response2 = get(clientPath1, serverPath, pwd1, prop2).Split("\n")[^1];
